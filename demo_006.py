...
from psignifit.evaluate import getThreshold, getSlope, getSlopePC, biasAna
from psignifit.psignifit import psignifit, psignifitFast
from psignifit.psigniplot import plotsModelfit
...
data11 = array([[0.0010,   22.0000,   45.0000],
...
data12 = array([[0.0010,   23.0000,   45.0000],
...
data21 = array([[ 0.0010,   33.0000,   45.0000],
...
data22 = array([[ 0.0010,   12.0000,   45.0000],
...
data31 = array([[0.0010,   22.0000,   45.0000],
...
data32 = array([[0.0010,   23.0000,   45.0000],
    [0.0015,   25.0000,   45.0000],
    [0.0020,   20.0000,   43.0000],
    [0.0025,   24.0000,   46.0000],
