...
from numpy import nan, array, empty, ones, zeros, append, log, exp
...
from .private.utils import my_norminv, my_t1icdf
...
def getSlopePC(result, pCorrect, unscaled = False):
    ...
    if unscaled:
        ...
        assert (pCorrect > theta0[3] and pCorrect < (1-theta0[2])), str('pCorrect must lay btw %f and %f', theta0[3], 1-theta0[2])
...
def getThreshold(result,pCorrect, unscaled=False):
    ...
    assert (pCorrect>theta0[3] and pCorrect<(1-theta0[2])), 'The threshold percent correct is not reached by the sigmoid!'
    ...
    CI = zeros([len(result['options']['confP']),2])
