...
from psignifit.psigniplot import plotPrior, plotPsych, plotMarginal
...
data=array([[1.5000,   3.0000,   3.0000],
...
plt.figure()
plotPsych(resRange)
plt.hold(True)      #TODO adjust to whatever I will do in plotting scripts
plotPsych(res)
